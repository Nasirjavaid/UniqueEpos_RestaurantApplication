...
class AppTheme {
  ...
  static const Color appDefaultColor = Colors.redAccent;
...
//By me
  static final TextStyle _lightScreenTextStyleDisplay1 =
      GoogleFonts.lato(textStyle: TextStyle(fontSize: 34.0, color: _lightOnPrimaryColor));
  static final TextStyle _lightScreenTextStyleDisplay2 =
      GoogleFonts.lato(textStyle: TextStyle(fontSize: 45.0, color: _lightOnPrimaryColor));
  static final TextStyle _lightScreenTextStyleDisplay3 =
       GoogleFonts.lato(textStyle:TextStyle(fontSize: 56.0, color: _lightOnPrimaryColor));
  static final TextStyle _lightScreenTextStyleDisplay4 =
     GoogleFonts.lato(textStyle:  TextStyle(fontSize: 112.0, color: _lightOnPrimaryColor));
  static final TextStyle _lightScreenTextStyleHeadline =
      GoogleFonts.lato(textStyle: TextStyle(fontSize: 24.0, color: _lightOnPrimaryColor));
  static final TextStyle _lightScreenTextStyleTitle =
      GoogleFonts.lato(textStyle: TextStyle(fontSize: 20.0, color: _lightOnPrimaryColor));
  static final TextStyle _lightScreenTextStyleSubhead =
       GoogleFonts.lato(textStyle:TextStyle(fontSize: 16.0, color: _lightOnPrimaryColor));
  static final TextStyle _lightScreenTextStyleBody1 =
      GoogleFonts.lato(textStyle: TextStyle(fontSize: 11.0, color: Colors.black54));
  static final TextStyle _lightScreenTextStyleBody2 =
      GoogleFonts.lato(textStyle: TextStyle(fontSize: 14.0, color: _lightOnPrimaryColor));
  static final TextStyle _lightScreenTextStyleCaption =
      GoogleFonts.lato(textStyle: TextStyle(fontSize: 12.0, color: _lightOnPrimaryColor));
  ...
  static final TextStyle _lightScreenTextStyleSubOverLine =
      GoogleFonts.lato(textStyle: TextStyle(fontSize: 10.0, color: _lightOnPrimaryColor));
//
