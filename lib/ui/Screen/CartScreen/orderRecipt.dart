...
class OrderRecipt extends StatefulWidget {
  ...
  OrderRecipt({this.orderinfo, this.data, this.conteextA});
  @override
  _OrderReciptState createState() => _OrderReciptState();
}
...
class _OrderReciptState extends State<OrderRecipt> {
        ...
        body: Center(
          child: Padding(
            ...
            child: Screenshot(
              ...
              child: Card(
                  elevation: 6,
                  child: _buildBody(context, widget.orderinfo, widget.data)),
            ),
          ),
        ));
  }
  ...
  void saveAnsShareImage(int requestCode, BuildContext context) {
    ...
    screenshotController.capture().then((File image) async {
      ...
      _showToast(context, "Recipt saved");
    }).catchError((onError) {
      print(onError);
    });
  ...
  void _listenForPermissionStatus() async {
    try {
      ...
      // } else {
      //   Methods.storeStateToSharedPref(true);
      // }
